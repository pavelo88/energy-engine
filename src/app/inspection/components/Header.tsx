...
export default function Header({ activeTab, isOnline, onNavigate }: HeaderProps) {
  return (
    // Cabecera con estilo Glassmorphism: fondo translúcido y sombra sutil
    <header className="px-6 py-4 bg-slate-800 backdrop-blur-lg border-b border-white/80 flex justify-between items-center sticky top-0 z-50 xl:hidden shadow-sm">
